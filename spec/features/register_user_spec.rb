...
feature "User creates an account" do
    ...
    scenario "successfully creates a new user account" do
        fill_in "user_first_name", with: "Cesar"
        fill_in "user_last_name", with: "Francisco"
        fill_in "user_email", with: "princexcesar@gmail.com"
    ...
    scenario "doesn't fill out first name field" do 
        fill_in "user_last_name", with: "Cesar"
        fill_in "user_email", with: "princexcesar@gmail.com"
        click_button "Create User"
    ...
    scenario "doesn't fill out email field" do 
        fill_in "user_first_name", with: "Cesar"
        fill_in "user_last_name", with: "Frnacisco"
        click_button "Create User"
